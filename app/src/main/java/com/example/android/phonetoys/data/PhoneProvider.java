...
import static com.example.android.phonetoys.R.id.quantity;

/**
 * {@link ContentProvider} for the Phones app
 */
...
public class PhoneProvider extends ContentProvider {
    ...
    /** URI matcher code for the content URI for a single phone in the pets table */
    ...
    static {
        ...
        // The content URI of the form "content://com.example.android.phones/phones/#" will map to the
        // integer code {@link #PHONE_ID}. This URI is used to provide access to ONE single row
        // of the phones table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.example.android.phones/phones/3" matches, but
        // "content://com.example.android.phones/phones" (without a number at the end) doesn't match.
    ...
    private int updatePhone(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        // If the {@link PhoneEntry#COLUMN_PET_NAME} key is present,
        ...
        // If the {@link PhoneEntry#COLUMN_PHONE_QUANTITY} key is present,
        ...
        // If the {@link PhoneEntry#COLUMN_PHONE_PRICE} key is present,
        // check that the weight value is valid.
